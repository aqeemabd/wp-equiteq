    ...
    <div class="container">
        ...
        <div class="row position-relative">
            <div class="col-md-8">
                ...
                <div>
                    Equiteq is the leading global investment bank for the Knowledge Economy.
                    Equiteq provides merger, acquisition and advisory services.
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="copyright pt3">
                    Copyright &copy; Equiteq <?php echo date('Y'); ?>
                </div>
            </div>
        </div>
